...
function showmeProducto(str)
{
var xmlhttp;    
if (str=="")
  {
  document.getElementById("muestrameProducto").innerHTML="";
  return;
  }
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("muestrameProducto").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","ajax/datosProducto.php?q="+str,true);
xmlhttp.send();
}
...
//Validación y enmascaramiento de numeracion
